...
<meta charset="UTF-8">
<title>상세 페이지</title>
<link rel="stylesheet" type="text/css" href="/group5/css/GamePage.css">
<style>
#dod{
    position: relative;
    top: -239px;
    ...
    <script>
        ...
        var mediaPaths = [
            ...
            try {
                ...
                Connection connection = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "temp", "1234");
...
try {
	...
	String sql2="SELECT DISTINCT i.content, content_no, content_type, g.genre_no, feature_no, n.genre_name, m.feature_name\r\n"
			   + "FROM game_info_content i, game_feature f, game_genre g, genre_number n, feature_number m\r\n"
			   + "WHERE i.g_no = '1011'\r\n" + "  AND i.g_no = f.g_no\r\n" + "  AND f.g_no = g.g_no\r\n"
			   + "  AND n.genre_no = g.genre_no\r\n" + "  AND m.g_no = f.feature_no\r\n"
...
<%
		...
		try {
			...
			String sql6="SELECT TO_CHAR(release_date, 'YYYY-MM-DD') AS formatted_date, m.graphic,r.graphic graphic_1,p.platform,ori_prc,m.os,r.os os_1,m.process,r.process process_1,\r\n"
					...
					+ "m.g_no='1011'";
			Connection conn5 = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "temp", "1234");
...
">
    ...
    top: 15px;">
				...
				<br>
				<br>
				<button id="gamepagebtn" onclick="paymentBtn()">지금 구매</button>
				<br>
				<br>
		...
		<div>
			<%-- 이미지 버튼들 --%>
        <div id="imagesButtonsContainer" style="
    position: relative;
    left: 150px;
">
        <img src="images/left.png" alt="left images"
            ...
            try {
                ...
                int imagesCount = 0; // 이미지 개수를 세기 위한 변수
                while (resultSet.next() && imagesCount < 6) { // 최대 6개 이미지까지만 표시
                    String url = resultSet.getString("media_url");
                    int mediaType = resultSet.getInt("media_type");
                    if (mediaType == 0 || mediaType == 1) {
            ...
            %>
				...
				<img src="images/right.png" alt="right images"
...
<jsp:include page="paymentYGgames.jsp"/>
