			...
			$('.payment_order_btn').click(function(){
				...
				if(btnValue=="kakaoPay"){
						...
						$.ajax({
							...
							data: {
								...
								total_amount: 1004,
								tax_free_amount: 0,
								approval_url : "http://localhost:9090/group5/main.jsp",
								cancel_url: "http://localhost:9090/group5/paymentYGgames.jsp",
								fail_url: "http://localhost:9090/group5/paymentYGgames.jsp",
								},
				...
				if(btnValue=="naverPay"){
					...
					oPay.open({
				          ...
				          "taxScopeAmount": "1000",
				          "taxExScopeAmount": "0",
				          "returnUrl": "http://localhost:9090/group5/main.jsp"
				    });
				}
				if(btnValue=="nicePay"){
					AUTHNICE.requestPay({
