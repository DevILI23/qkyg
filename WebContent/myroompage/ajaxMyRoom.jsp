...
try{
	...
	Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","group5","abcd1234");
	String sql = "";
...
<div class="profile-container">
	...
	<script defer src="/group5/js/ProfileSectionMove.js"></script>
	<script defer src="/group5/js/UpdateTitle.js"></script>
	<script defer src="/group5/js/FriendsRefresh.js"></script>
	<script>
