...
<jsp:include page="/communitypage/CommunitySideBar.jsp" />
	<div class="right">
		<div class="rightBackImg">
			<div id="postSearchBox">
				...
				<form action="/communitypage/Community_Search.jsp" method="get" name="searchForm">
			...
			<div id=showPost>
				...
				<div id="replyBoxWrite">
						...
						<span><%
							out.print(loginNickname);
						%></span><br/>
						<form action="/communitypage/Community_ShowBoard.jsp" method="post">
