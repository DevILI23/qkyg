...
<body>
	<div class="ka">
		...
		<div id="post_searchBox">
			<div id="dodImg">
				<img src="/group5/images/search.png" alt="돋보기" id="dod" style="margin:8px;"> 
			</div>
		...
		<div class="category">
			<br>
			<a href = "/group5/searchingpage/SearchingGame.jsp">
				<span class="categorySpan">
					찾아보기
				</span>
			</a>
		...
		<div class="category">
			<br>
			<a href="/group5/Controller?command=news" class="nav-item-links nav-txt-links" tabindex="-1">
                                    새소식
            </a>
		</div>
	</div>
	<script>
		...
		function showSearchResults(keyword) {
			...
			if (keyword.length > 0) {
				...
				xhr.open('POST', '/group5/outframe/SearchServlet.jsp', true);
